	...
	jQuery(function() {
		...
		var sticky_navigation = function(){
			...
			if (scroll_top > sticky_navigation_offset_top) { 
				...
				jQuery('#sticky_navigation').stop(true).animate({'min-height':'130px'}, 500);
				...
				$( ".page-template-template-home-page-php #give-a-fork" ).slideUp( 300 ,function(){enable_scroll();});
			} else {
				jQuery('#sticky_navigation').stop(true).animate({'min-height':'130px'}, 100);
				...
				$( ".page-template-template-home-page-php #give-a-fork" ).slideDown( 300 );
			}
		};
