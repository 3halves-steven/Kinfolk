        ...
        return this.each(function () {
            ...
            function showMeanMenu() {
                if (currentWidth <= meanScreenWidth) {									meanMenuExist = true;
                	...
                	jQuery('.mean-container').prepend('<div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="'+meanStyles+'">Show Navigation</a><a href="/contact/" class="mobile-time"><span>'+open_title+'</span><br />'+open_detail+'</a><nav class="mean-nav"></nav></div>');				                    
